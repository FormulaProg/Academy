...
const courses = [
    {
        ...
        text: `
            ...
            <div class="course-text">
                <p>Зазвичай шлях у C++ починають із загального шаблону програми.</p>
...
int main() {
    return 0;
            ...
            <p>Тепер розберемо кожен рядок окремо.</p>
            <p class="course-text1">Перший рядок:</p>
            <pre><code>#include &lt;iostream&gt;</code></pre>
            <p>Це ми вказали бібліотеку. Бібліотека - це готовий набір інструментів. Підключаючи її, ми можемо користуватися цими інструментами. Бібліотека iostream дозволяє приймати дані, які вводить користувач, та виводити дані користувачу.</p>
            <p class="course-text1">Другий рядок:</p>
            <pre><code>using namespace std;</code></pre>
            <p>Додаючи цей рядок, нам не потрібно щоразу писати std:: перед елементами стандартної бібліотеки.</p>
            <p class="course-text1">Третій рядок:</p>
            <pre><code>int main() {</code></pre>
            <p>main() - функція, з якої починається виконання C++-програми. Увесь наступний код ми записуємо усередині фігурних дужок.</p>
            <p class="course-text1">Четвертий рядок:</p>
            <pre><code>return 0;</code></pre>
            <p>return 0; завершує виконання функції main() і повертає операційний системі значення 0, яке зазвичай означає успішне завершення програми.</p>
            <br><br><br><br><br><br>
            </div>
        `
    },
...
<pre><code>TF = True # приймає значення True або False (bool)</code></pre>
                <p>Так ми присвоїли змінним number, text та TF значення відповідних типів даних</p>
                <br>
...
math.floor(a) # округлення вниз до цілого числа</code></pre>
                <br>
